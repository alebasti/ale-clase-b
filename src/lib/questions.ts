...
export const allQuestions: Question[] = [
    ...
    {
        question: "12.- ¿Cuándo usaría usted las luces intermitentes de advertencia de peligro?",
        options: [
    ...
    {
        question: "23.- ¿Por qué no es bueno desenganchar el motor al ir circulando?",
        options: [
    ...
    },
    {
        ...
        options: [
            ...
            "c) Para quienes viajan en el asiento trasero el cinturón de seguridad no les presta utilidad.",
    ...
    {
        question: "38.- El auto azul circula a 70 km/h y el rojo a 90 km/h. ¿Dónde es más probable que sus conductores estimen el punto en que se producirá el encuentro de ambos vehículos? (Marque dos respuestas)",
    ...
    {
        question: "51.- Usted va a 70 km/hr. Aproximadamente, ¿qué distancia recorrerá su vehículo desde el momento en que usted se percata de un peligro que hay más adelante hasta que comienza a frenar?",
        options: [
            "a) Unos 5 metros.",
            "b) Unos 8 metros.",
            "c) Unos 20 metros.",
    ...
    },
    {
        ...
        options: [
            ...
            "b) Que el conductor esté muy cansado o bajo os efectos del alcohol.",
            "c) Que el conductor esté bajo os efectos de medicamentos.",
    ...
    },
    {
        ...
        options: [
            ...
            "d) No hay maiores diferencias en cuanto a cómo observan el entorno los conductores inexpertos y los con gran experiencia."
        ],
        correctAnswer: "a",
        points: 1
    },
    ...
    },
    {
        ...
        options: [
            ...
            "b) Conducir sólo acompañado por alguien que posea una licencia de conducir.",
    ...
    {
        question: "88.- ¿De cuáles capacidades de un individuo, ¿cuál de ellas no se ve afectada por el consumo de alcohol?",
        options: [
    ...
    {
        question: "91.- ¿Qué debería hacer el conductor del auto señalado con la flecha?",
    ...
    {
        question: "92.- ¿Cuáles son las 2 principales razones por las que no sería adecuado que usted adelantara al peatón en este momento? (Marque dos respuestas)",
        ...
        options: [
            ...
            "d) Podria aparecer sorpresivamente algún vehículo en sentido contrario."
        ],
        correctAnswer: ["c", "d"],
        points: 2
    },
    ...
    {
        question: "94.- En esta ocasión usted va conduciendo a 70 km/h. ¿Qué hace usted? (Marque dos respuestas)",
    ...
    },
    {
        ...
        options: [
            "a) Mantenerse bien a la derecha ya que asi tardará menos en pasar la curva.",
    ...
    {
        question: "99.- Mire el dibujo. ¿Cuál es el peligro al que usted debe estar más atento(a)?",
    ...
    {
        question: "101.- Usted va conduciendo al lado de una fila de autos estacionados. De pronto ve una pelota rebotando en la calzada un poco más adelante. ¿Qué debería hacer usted?",
    ...
    {
        question: "105.- Usted está esperando en un cruce en T. El vehículo azul que se acerca desde la izquierda señaliza a la derecha. ¿Qué debería hacer usted?",
    ...
    {
        question: "106.- Usted se ha quedado detenido justo al medio de un cruce ferroviario con sistema automático de señales y barreras y no puede echar a andar el motor nuevamente. La campanilla del cruce comienza a sonar. ¿Qué debería hacer usted?",
        options: [
    ...
    {
        question: "107.- ¿A qué debe estar especialmente atento el conductor del vehículo indicado con la flecha? (Marque tres respuestas)",
    ...
    {
        question: "108.- ¿Qué debería hacer el conductor del auto indicado con la flecha?",
    ...
    {
        question: "109.- ¿Qué debería hacer el conductor del auto señalado con la flecha?",
    ...
    {
        question: "110.- ¿Cuál es el principal peligro cuando usted sobrepasa al bus que está detenido en la parada?",
    ...
    {
        question: "111.- ¿Qué significa la señal que está efectuando el camión?",
    ...
    {
        question: "112.- ¿Qué debe hacer usted cuando va en una fila de autos? (Marque tres respuestas)",
        options: [
    ...
    {
        question: "113.- ¿Hacia dónde es más importante que usted mire en este momento?",
    ...
    {
        question: "114.- En esta situación, ¿a cuáles 3 riesgos debe estar usted principalmente atento? (Marque tres respuestas)",
    ...
    {
        question: "115.- Usted va conduciendo a 70 km/h que es la velocidad máxima permitida en esta vía. ¿Qué hace en esta situación? (Marque la o las respuesta(s) correcta(s))",
    ...
    {
        question: "116.- ¿Qué hace usted ante esta situación?",
    ...
    {
        question: "123.- Las fotografías muestran una secuencia cronológica de imágenes. ¿Cuáles son las 2 principales causas por las que surge esta situación de peligro? (Marque dos respuestas)",
    ...
    {
        question: "125.- ¿En cuál situación puede usted hacer uso de la bocina de su vehículo?",
        options: [
    ...
    {
        question: "127.- Usted se aproxima a un cruce semaforizado. ¿Cuándo no debe usted ingresar al cruce aunque el semáforo esté en verde?",
        options: [
    ...
    },
    {
        ...
        options: [
            ...
            "c) El otro vehiculo, siempre que él se venga acercando al cruce por el lado derecho suyo.",
    ...
    },
    {
        ...
        options: [
            ...
            "d) En el asiento delantero, en una silla de seguridad mirando hacia atrás, pero sólo si el vehículo no posee doble airbag.",
    ...
    {
        question: "138.- Usted va por una calle de sentido único de tránsito y desea virar a la izquierda. ¿Cuál o cuáles de las siguientes afirmaciones es(son) correcta(s)? (Marque la o las respuesta(s) correcta(s))",
    ...
    {
        question: "139.- ¿En cuál o cuáles de las siguientes situaciones puede usted virar a la izquierda sin que siempre deba detenerse antes? (Marque la o las respuesta(s) correcta(s))",
    ...
    {
        question: "140.- ¿Frente a cuál o cuáles de las siguientes señales e indicaciones del semáforo debe usted detenerse siempre? (Marque la o las respuesta(s) correcta(s))",
    ...
    {
        question: "142.- Usted va detrás de un camión articulado que va a doblar a la derecha hacia una vía angosta. ¿Qué debe hacer usted?",
        options: [
    ...
    {
        question: "143.- ¿Cómo señaliza usted con el brazo cuando va a virar hacia la derecha?",
    ...
    {
        question: "144.- ¿Cuál señalización con el brazo del conductor de un vehículo que va adelante le indica que va a virar a la izquierda?",
    ...
    {
        question: "145.- Usted ha comenzado a adelantar. El auto de la derecha va a aproximadamente 80 km/h. Por su espejo retrovisor usted ve otro auto que tiene intención de adelantar. ¿Qué hace usted?",
        ...
        options: [
            ...
            "d) Acelera y adelanta, ya que el ancho de la calzada es suficiente para 3 vehiculos si el que viene en contra se corre bien a su derecha."
        ],
        correctAnswer: "a",
        points: 1
    },
    {
        question: "146.- Usted va conduciendo a 90 km/h que es la velocidad máxima permitida en esa vía. ¿Qué hace usted si a pesar de todo un vehículo desea adelantarlo? (Marque dos respuestas)",
    ...
    {
        question: "148.- Usted desea adelantar. ¿Cuál o cuáles de las siguientes afirmaciones es(son) verdadera(s)? (Marque la o las respuesta(s) correcta(s))",
    ...
    {
        question: "149.- Usted ha comenzado a adelantar. El auto de la derecha va a aproximadamente 80 km/h. Por su espejo retrovisor usted ve otro auto que tiene intención de adelantar. ¿Qué hace usted?",
        image: "img/pregunta_149.png",
        options: [
            "a) Frena ligeramente y vuelve a la pista derecha.",
            "b) Acelera y adelanta, porque el auto que usted adelanta tiene la obligación de reducir la velocidad.",
    ...
    },
    {
        ...
        options: [
            ...
            "c) Para tener espacio suficiente en caso que el vehiculo se detenga y retroceda.",
    ...
    {
        question: "156.- ¿En cuál o cuáles de los siguientes lugares podría el estacionamiento de su vehículo causar daño u obstrucción a otros usuarios de la vía? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "157.- ¿En cuál o cuáles de los siguientes lugares usted no debe estacionar? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "161.- Como regla general, ¿en cuál o cuáles de los siguientes lugares nunca debe estacionar? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "165.- ¿En cuáles 3 de los siguientes lugares debe usted detener siempre su vehículo? (Marque tres respuestas)",
        options: [
    ...
    {
        question: "166.- ¿A cuántos metros de una esquina es lo más cerca que usted puede estacionar?",
    ...
    {
        question: "169.- ¿Qué hace usted ante esta situación?",
    ...
    {
        question: "170.- Usted va conduciendo a 90 km/h cuando la vía es obstruida sorpresivamente por un camión que está virando a la izquierda. ¿Qué es lo primero que hace usted?",
    ...
    {
        question: "171.- ¿Adquiere usted un derecho sobre otros usuarios de la vía cuando utiliza sus luces indicadoras de viraje?",
        options: [
    ...
    {
        question: "172.- Usted se aproxima a un cruce cebra. En la vereda hay peatones esperando para cruzar. ¿Qué hace usted?",
        options: [
    ...
    {
        question: "173.- Usted va circulando por una vía rápida en buenas condiciones. ¿Cómo puede estar seguro de que lo hace a una distancia adecuada del vehículo que va delante suyo?",
        options: [
            "a) La distancia entre usted y el vehículo que va delante debería ser dos veces el largo de su vehículo.",
            "b) La distancia entre usted y el vehículo que va delante debería ser igual a su distancia de frenado.",
            "c) La distancia entre usted y el vehículo que va delante debería ser a lo menos igual a la que usted recorre en tres segundos.",
            "d) La distancia entre usted y el vehículo que va delante debería ser a lo menos igual a la que usted recorre en un segundo."
        ],
        correctAnswer: "c",
        points: 1
    },
    {
        question: "174.- Usted va conduciendo a 100 km/h. En condiciones normales, ¿cuál es la distancia mínima de seguridad que usted debería mantener respecto del vehículo que va adelante?",
        options: [
            "a) Unos 75 metros",
            "b) Unos 15 metros",
            "c) Unos 20 metros",
    ...
    {
        question: "176.- Un bus está detenido en una parada delante suyo. El intermitente izquierdo del bus está parpadeando. ¿Qué hace usted?",
    ...
    {
        question: "177.- Usted está conduciendo al límite de la velocidad máxima permitida y un conductor intenta adelantarlo. ¿Qué hace usted?",
        options: [
    ...
    },
    {
        ...
        options: [
            ...
            "c) Enciende y apaga sus luces para manifestarle su enojo.",
    ...
    {
        question: "183.- Usted está a punto de incorporarse a una vía principal desde una calle lateral. ¿Por qué razón debería usted poner especial atención a las motocicletas?",
        options: [
    ...
    {
        question: "186.- Usted va detrás de un camión articulado que se aproxima a un cruce. Su conductor signaliza hacia la derecha pero el vehículo se desplaza hacia la izquierda. ¿Qué debe hacer usted?",
    ...
    {
        question: "187.- En una carretera de doble calzada con 2 pistas por sentido, usted está siendo seguido muy de cerca por un vehículo que viene atrás. ¿Qué debería hacer usted?",
        options: [
    ...
    {
        question: "191.- En un cruce hay peatones atravesando la calle hacia la cual usted está virando. ¿Qué debe hacer usted?",
    ...
    {
        question: "192.- En un cruce hay peatones atravesando la calle hacia la cual usted está virando. ¿Qué hace usted?",
        image: "img/pregunta_92.png",
        options: [
    ...
    {
        question: "195.- Usted se encuentra muy próximo a un cruce en el que pretende virar a la derecha. Delante suyo va un ciclista. ¿Qué hace usted?",
        options: [
            ...
            "d) Se sitúa al lado del ciclista, sigue en linea recta y desiste de virar."
        ],
        correctAnswer: "c",
        points: 1
    },
    ...
    {
        question: "199.- Usted desea adelantar a una motociclista que va delante suyo, ¿qué hace usted?",
        options: [
    ...
    {
        question: "201.- Al estacionar su vehículo en un lugar en el que no hay señales que lo permitan ni que lo prohiban, usted no debe...",
        options: [
    ...
    {
        question: "202.- Usted nunca debería intentar adelantar a un ciclista...",
        options: [
    ...
    {
        question: "203.- Cuando adelanta a un ciclista usted debe dejar el máximo espacio lateral posible. ¿Por qué?",
        options: [
    ...
    {
        question: "204.- Cuando el viento está soplando muy fuerte, ¿por qué debe usted dejar un espacio lateral extra al adelantar a un motociclista?",
        options: [
            "a) Porque el motociclista podría doblar repentinamente para escapar del viento.",
            "b) Porque el motociclista podria detenerse repentinamente.",
    ...
    {
        question: "205.- ¿De qué le advierte esta señal?",
    ...
    {
        question: "206.- Cuando es de noche, al adelantar usted debería... (Marque dos respuestas)",
        options: [
    ...
    {
        question: "207.- Por una carretera, usted circula detrás de otro vehículo. Si la calzada está mojada, ¿qué espacio de tiempo mínimo mantiene usted respecto del vehículo que va adelante?",
        options: [
    ...
    {
        question: "208.- Usted está conduciendo de noche y es encandilado por las luces delanteras de un vehículo que se aproxima. En estas circunstancias, ¿qué hace usted?",
        options: [
    ...
    {
        question: "209.- ¿Cuál o cuáles de las siguientes afirmaciones son correctas en cuanto a la conducción durante la noche? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "210.- ¿Cuál o cuáles de las siguientes afirmaciones es(son) correcta(s) en cuanto a la conducción nocturna en un camino rural? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "211.- ¿Cuál o cuáles de las siguientes afirmaciones es(son) correcta(s) en cuanto a la conducción bajo la lluvia? (Marque la o las respuesta(s) correcta(s))",
        options: [
            "a) Cuando los neumáticos son nuevos no hay riesgo de que éstos patinen a consecuencia del agua en la calzada.",
            "b) Independientemente del estado de los neumáticos, el riesgo de que éstos patinen es maior mientras maior es la velocidad.",
    ...
    {
        question: "212.- ¿Cuáles son las 2 causas más comunes de los resbalones ante la existencia de agua en la calzada? (Marque dos respuestas)",
        options: [
    ...
    {
        question: "213.- Viajando de noche usted es encandilado por las luces de un vehículo que viene en sentido contrario, ¿qué debería hacer usted?",
        options: [
    ...
    {
        question: "214.- Conduciendo de noche usted se ve encandilado por las luces de un vehículo que viene en sentido contrario, ¿qué debería hacer usted?",
        options: [
            "a) Frenar fuerte.",
    ...
    {
        question: "215.- Al frenar en una calzada mojada su vehiculo comienza a patinar. ¿Qué es lo primero que usted debería hacer?",
        options: [
    ...
    {
        question: "216.- ¿Cómo puede usted evitar que los neumáticos patinen cuando la calzada está cubierta con una capa de hielo?",
        options: [
    ...
    {
        question: "217.- Cuando la calzada está con hielo la distancia de frenado puede ser ...",
        options: [
    ...
    {
        question: "218.- Al conducir con neblina a la luz del día, ¿qué luces enciende usted?",
        options: [
    ...
    {
        question: "219.- Al conducir sobre una calzada con hielo usted siente la dirección de su vehículo más liviana. ¿Por qué sucede esto?",
        options: [
    ...
    {
        question: "220.- ¿Cuándo es su distancia de detención total mucho más larga?",
        options: [
    ...
    {
        question: "221.- Usted acaba de conducir a través de una calle inundada. ¿Qué es lo primero que debería hacer?",
        options: [
    ...
    {
        question: "222.- ¿Cómo puede usted evitar que su vehículo patine cuando la calzada está cubierta con una capa de hielo?",
        options: [
    ...
    {
        question: "223.- Usted está conduciendo bajo mucha lluvia y repentinamente siente la dirección muy liviana. ¿Qué hace usted para tener nuevamente el control de su vehículo?",
        options: [
    ...
    {
        question: "226.- En un caso de mucha neblina usted va detrás de otros vehículos y lleva encendidas sus luces bajas. ¿De qué otra forma puede reducir las probabilidades de verse involucrado en un accidente?",
        options: [
    ...
    {
        question: "228.- ¿Cómo puede usted controlar mejor su vehículo al conducir con nieve?",
        options: [
    ...
    {
        question: "229.- Al ir de noche por una carretera usted debe mantener sus focos delanteros encendidos, a menos que ...",
        options: [
            "a) su vehículo esté en pana en la berma.",
            "b) vayan vehiculos muy cerca delante suyo.",
    ...
    {
        question: "230.- ¿Cómo debería conducir usted en una curva cuando hay hielo en la calzada?",
        options: [
    ...
    {
        question: "231.- Hay mucha neblina y el auto que viene detrás suyo parece estar muy cerca. ¿Qué debería hacer usted?",
        options: [
            "a) Encender sus luces de advertencia de peligro.",
    ...
    {
        question: "232.- Usted va conduciendo de noche por una carretera cerca de otros vehículos que van delante suyo. ¿Qué luces debería mantener encendidas?",
        options: [
    ...
    {
        question: "233.- ¿Por qué razón deberia usted reducir siempre su velocidad al conducir con neblina?",
        options: [
    ...
    {
        question: "234.- Su vehículo ha quedado en pana en medio de una autopista. ¿Qué es lo primero que usted debería hacer?",
        options: [
    ...
    {
        question: "235.- Usted va circulando por la pista de la derecha de una carretera de doble calzada muy transitada. Una señal le indica que a 800 m su pista se encuentra cerrada. ¿Qué debería hacer usted?",
    ...
    {
        question: "236.- En una calle de una pista por sentido de tránsito usted se encuentra con que su pista está obstruida. ¿Qué hace usted?",
    ...
    {
        question: "237.- Usted va tirando un remolque pequeño que comienza a zigzaguear.¿Qué hace usted?",
        options: [
    ...
    {
        question: "238.- ¿Qué precaución debe tomar usted al cargar un remolque que va a arrastrar con su automóvil?",
        options: [
    ...
    {
        question: "239.- ¿Cómo puede usted detener el zigzagueo de una casa rodante que va remolcando?",
        options: [
    ...
    {
        question: "241.- En una carretera de doble calzada y de mucho tránsito, usted está siendo seguido muy de cerca por un vehículo que viene atrás. ¿Qué hace usted para disminuir el riesgo de accidente?",
        options: [
            "a) Sale a la berma y se detiene.",
            "b) Enciende sus luces de advertencia de peligro.",
            "c) Frena.",
            "d) Aumenta su distancia al vehiculo que va adelante."
        ],
        correctAnswer: "d",
        points: 1
    },
    {
        question: "242.- Combine los números de las señales con los textos que correspondan.",
    ...
    {
        question: "243.- Usted va circulando por una carretera de doble calzada con tres pistas por sentido. Las demarcaciones de pistas y de eje central están reforzadas con tachas reflectantes. Si a su izquierda las tachas son rojas y a su derecha éstas son blancas, ¿por cuál pista va usted?",
        options: [
    ...
    {
        question: "244.- Al ir circulando en su vehiculo usted enfrenta esta señal. ¿Qué significa?",
        image: "img/pregunta_244.png",
        options: [
            "a) Que usted no debe exceder esta velocidad.",
            "b) Que usted puede conducir hasta un 10% más rápido, porque la señal es sólo una recomendación.",
            "c) Que en días no hábiles, cuando hay poco tránsito, no rige tal restricción.",
    ...
    {
        question: "245.- ¿Qué significa esta señal?",
    ...
    {
        question: "246.- ¿Qué debe hacer usted cuando enfrenta esta señal?",
        image: "img/pregunta_246.png",
        options: [
            "a) Detenerse sólo si viene algún vehículo por la otra via.",
            "b) Detenerse sólo si hay peatones esperando para cruzar.",
            "c) Detenerse sólo si en la calzada está pintada la leyenda PARE.",
            "d) Detenerse siempre."
        ],
        correctAnswer: "d",
        points: 1
    ...
    {
        question: "247.- ¿Qué significa esta señal?",
    ...
    {
        question: "248.- ¿Qué significa esta señal?",
    ...
    {
        question: "249.- ¿Cuál de los siguientes tipos de señales le indica que no haga algo?",
    ...
    {
        question: "250.- ¿Qué significa esta señal?",
    ...
    {
        question: "251.- ¿Qué significa un semáforo en rojo?",
        options: [
    ...
    {
        question: "252.- ¿Para qué sirven las señales amarillas con forma de rombo?",
        options: [
    ...
    {
        question: "253.- ¿Qué significa un semáforo en amarillo?",
        options: [
    ...
    {
        question: "254.- ¿Qué significa esta señal?",
        image: "img/pregunta_255.png",
        options: [
            "a) Angostamiento de la via.",
    ...
    {
        question: "255.- ¿Qué significa esta señal?",
    ...
    {
        question: "256.- ¿Cuál de estas señales le previene que más adelante hay una serie de curvas?",
    ...
    {
        question: "257.- ¿Qué significa esta señal?",
    ...
    {
        question: "258.- ¿Cuál de estas señales le advierte la proximidad de un cruce de peatones?",
    ...
    {
        question: "259.- De las siguientes señales de tránsito, ¿cuál o cuáles corresponden a señales amarillas con forma de rombo? (Marque la o las respuesta(s) correcta(s))",
        options: [
            "a) Puente angosto",
    ...
    {
        question: "260.- Usted está enfrentando un semáforo en amarillo. ¿Qué luces se encenderán después?",
        options: [
    ...
    {
        question: "261.- ¿Qué significa la demarcación de centro de calzada que muestra la figura?",
    ...
    {
        question: "262.- El vehiculo indicado con la flecha se encuentra detenido sobre una zona achurada esperando poder efectuar un viraje en U, ¿es esto correcto?",
        image: "img/pregunta_263.png",
        options: [
            "a) Sí, la zona achurada sólo separa sentidos de circulación.",
            "b) Si, siempre que la zona achurada no esté reforzada con tachas o tachones reflectantes.",
    ...
    {
        question: "263.- De acuerdo a las circunstancias que se aprecian en la fotografía, ¿sería correcto que el automóvil indicado con la flecha continuara derecho ?",
    ...
    {
        question: "264.- ¿Qué le indica la señal de tránsito que se observa en la fotografía?",
    ...
    {
        question: "265.- ¿Qué significa la luz verde del semáforo?",
        options: [
    ...
    {
        question: "266.- ¿Cuándo no debería usted detenerse al ponerse el semáforo en amarillo? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "267.- Usted se encuentra en el lugar de un accidente. ¿Qué hace para ayudar de mejor forma a una persona herida que está con una fuerte hemorragia en la parte inferior de una pierna? (Marque dos respuestas)",
        options: [
    ...
    {
        question: "268.- Excepcionalmente, un joven de 17 años puede obtener licencia de conducir clase B. En tanto no cumpla 18 años deberá conducir siempre acompañado. ¿Qué requisitos debe cumplir su acompañante? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "269.- Usted se ve involucrado en un accidente. Un pasajero del otro vehículo ha resultado con lesiones leves. ¿Debe usted informar el hecho a la policía?",
        options: [
            ...
            "d) Si, debe dar cuenta del hecho a la autoridad policial más inmediata a la brevedad."
        ],
        correctAnswer: "d",
        points: 1
    },
    {
        question: "270.- Usted se ha detenido en el lugar de un accidente para prestar ayuda. ¿Qué debería hacer usted? (Marque tres respuestas)",
        options: [
            ...
            "d) Mantener tranquilas a las personas heridas hablándoles alentadorarmente.",
    ...
    {
        question: "271.- Usted es el primero en llegar al sitio de un accidente. ¿Qué debería hacer usted? (Marque la o las respuesta(s) correcta(s))",
        options: [
            ...
            "d) Ayudar a salir a las personas ilesas de los vehiculos."
        ],
        correctAnswer: ["a", "b", "d"],
        points: 3
    },
    {
        question: "272.- Usted es el primero en llegar al lugar de un accidente en el que hay heridos graves. ¿Qué hace usted? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "273.- Usted llega al lugar de un accidente en el que ha participado un camión cargado con productos químicos peligrosos. ¿Qué debería hacer usted antes de llamar al 133 de Carabineros?",
        options: [
    ...
    {
        question: "274.- Usted llega al lugar de un accidente en el que ha participado un motociclista. El motociclista yace consciente, pero en estado de shock. ¿De qué debería asegurarse usted?",
        options: [
    ...
    {
        question: "275.- Usted va por una autopista. De un camión cargado que va delante suyo cae una caja sin que su conductor se dé cuenta. ¿Qué hace usted?",
        options: [
            "a) Trata de alcanzar al camión y de llamar la atención de su conductor.",
            "b) Se detiene junto a la caja y enciende sus luces de emergencia hasta que llegue la policia.",
            "c) Se desplaza hacia la berma y luego intenta recoger la caja.",
            "d) Continúa hasta donde haya un teléfono para avisar a la policia o a los servicios de emergencia."
        ],
        correctAnswer: "d",
        points: 1
    },
    {
        question: "276.- ¿Quién o quiénes están cubiertos por el Seguro Obligatorio de Accidentes Personales?",
        options: [
    ...
    {
        question: "277.- ¿Qué documento no está obligado a portar usted siempre en su vehiculo?",
        options: [
            ...
            "e) El certificado de inscripción en el Registro Nacional de Vehiculos Motorizados."
        ],
        correctAnswer: "e",
        points: 1
    },
    {
        question: "278.- En relación con las infracciones a las normas del tránsito, ¿cuál o cuáles de las siguientes afirmaciones es(son) verdadera(s)? (Marque la o las respuesta(s) correcta(s))",
        options: [
            "a) Conducir un vehículo bajo los efectos del alcohol es una infracción gravísima.",
            "b) No respetar una señal PARE es una infracción gravisima.",
    ...
    {
        question: "279.- ¿Cuál o cuáles de las siguientes afirmaciones es(son) verdadera(s)? (Marque la o las respuesta(s) correcta(s))",
        options: [
            ...
            "e) No respetar una señal Ceda el Paso es una infracción gravisima si a consecuencia de la infracción se produce un accidente."
        ],
        correctAnswer: ["b", "c", "e"],
        points: 3
    }
