...
const allQuestions = [
    ...
    {
        question: "138.- Usted está en una calle de un solo sentido de tránsito y desea virar a la izquierda. ¿Cuál o cuáles de las siguientes afirmaciones es(son) correcta(s)? (Marque la o las respuesta(s) correcta(s))",
    ...
    {
        question: "146.- Usted va conduciendo su vehículo a 90 km/h que es la velocidad máxima permitida en esa vía. ¿Qué hace usted si a pesar de todo un vehículo desea adelantarlo? (Marque dos respuestas)",
    ...
    {
        question: "156.- ¿En cuál o cuáles situaciones el vehículo está mal estacionado? (Marque la o las respuesta(s) correcta(s))",
    ...
    {
        question: "157.- ¿En cuál o cuáles de las siguientes situaciones el conductor se ha detenido correctamente para recoger un pasajero? (Marque la o las respuesta(s) correcta(s))",
    ...
    {
        question: "170.- Usted conduce a 90 km/h cuando la vía es obstruida sorpresivamente por un camión que está virando a la izquierda. ¿Qué es lo primero que hace usted?",
    ...
    {
        question: "172.- Usted se aproxima a un cruce cebra. En la vereda hay peatones esperando cruzar. ¿Qué hace usted?",
        options: [
    ...
    {
        question: "186.- Usted va detrás de un camión articulado que se aproxima a un cruce. Su conductor señaliza hacia la derecha pero el vehículo se desplaza hacia la izquierda. ¿Qué debe hacer usted?",
    ...
    {
        question: "216.- ¿Cómo puede usted evitar que los neumáticos patinen cuando la calzada está con hielo?",
        options: [
    ...
    {
        question: "238.- En relación con el transporte de una carga sobre la parrilla de un automóvil, ¿cuál de las siguientes afirmaciones constituye una obligación para el conductor?",
        options: [
    ...
    {
        question: "246.- ¿Cuándo puede usted ingresar a un cruce en cuya calzada se han pintado franjas amarillas diagonales?",
    ...
    {
        question: "247.- ¿Qué significa esta señal de tránsito?",
    ...
    {
        question: "250.- ¿Qué debe hacer usted cuando enfrenta esta señal?",
    ...
    {
        question: "251.- ¿Qué significa esta señal?",
    ...
    {
        question: "252.- ¿Qué significa un semáforo en rojo?",
        options: [
    ...
    {
        question: "253.- ¿Para qué sirven las señales amarillas con forma de rombo?",
        options: [
    ...
    {
        question: "254.- ¿Qué significa un semáforo en amarillo?",
        options: [
    ...
    {
        question: "256.- ¿Qué significa esta señal?",
    ...
    {
        question: "257.- ¿Cuál de estas señales le previene que más adelante hay una serie de curvas?",
    ...
    {
        question: "258.- ¿Qué significa esta señal?",
    ...
    {
        question: "259.- ¿Cuál de estas señales le advierte la proximidad de un cruce de peatones?",
    ...
    {
        question: "260.- De las siguientes señales de tránsito, ¿cuál o cuáles corresponden a señales amarillas con forma de rombo? (Marque la o las respuesta(s) correcta(s))",
        options: [
            "a) Puente angosto",
    ...
    {
        question: "261.- Usted está enfrentando un semáforo en amarillo. ¿Qué luces se encenderán después?",
        options: [
    ...
    {
        question: "262.- ¿Qué significa la demarcación de centro de calzada que muestra la figura?",
    ...
    {
        question: "263.- El vehiculo indicado con la flecha se encuentra detenido sobre una zona achurada esperando poder efectuar un viraje en U, ¿es esto correcto?",
    ...
    {
        question: "264.- De acuerdo a las circunstancias que se aprecian en la fotografía, ¿sería correcto que el automóvil indicado con la flecha continuara derecho ?",
    ...
    {
        question: "265.- ¿Qué le indica la señal de tránsito que se observa en la fotografía?",
    ...
    {
        question: "266.- ¿Qué significa la luz verde del semáforo?",
        options: [
    ...
    {
        question: "267.- ¿Cuándo no debería usted detenerse al ponerse el semáforo en amarillo? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "268.- Usted se encuentra en el lugar de un accidente. ¿Qué hace para ayudar de mejor forma a una persona herida que está con una fuerte hemorragia en la parte inferior de una pierna? (Marque dos respuestas)",
        options: [
    ...
    {
        question: "269.- Excepcionalmente, un joven de 17 años puede obtener licencia de conducir clase B. En tanto no cumpla 18 años deberá conducir siempre acompañado. ¿Qué requisitos debe cumplir su acompañante? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "270.- Usted se ve involucrado en un accidente. Un pasajero del otro vehículo ha resultado con lesiones leves. ¿Debe usted informar el hecho a la policía?",
        options: [
    ...
    {
        question: "271.- Usted se ha detenido en el lugar de un accidente para prestar ayuda. ¿Qué debería hacer usted? (Marque tres respuestas)",
        options: [
    ...
    {
        question: "272.- Usted es el primero en llegar al sitio de un accidente. ¿Qué debería hacer usted? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "273.- Usted es el primero en llegar al lugar de un accidente en el que hay heridos graves. ¿Qué hace usted? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "274.- Usted llega al lugar de un accidente en el que participó un camión cargado con productos químicos peligrosos. ¿Qué debería hacer usted antes de llamar al 133 de Carabineros?",
        options: [
    ...
    {
        question: "275.- Usted llega al lugar de un accidente en el que ha participado un motociclista. El motociclista yace consciente, pero en estado de shock. ¿De qué deberia asegurarse usted?",
        options: [
    ...
    {
        question: "278.- ¿Qué documento no está obligado a portar usted siempre en su vehiculo?",
        options: [
    ...
    {
        question: "279.- En relación con las infracciones a las normas del tránsito, ¿cuál o cuáles de las siguientes afirmaciones es(son) verdadera(s)? (Marque la o las respuesta(s) correcta(s))",
        options: [
    ...
    {
        question: "280.- ¿Cuál o cuáles de las siguientes afirmaciones es(son) verdadera(s)? (Marque la o las respuesta(s) correcta(s))",
        options: [
